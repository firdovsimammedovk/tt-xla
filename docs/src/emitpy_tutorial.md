...
- PyTorch: `examples/pytorch/codegen/resnet.py` (under the repository root)
- JAX: `examples/jax/codegen/resnet.py`

### Learn More

- **[Code Generation Guide](./getting_started_codegen.md)** - Complete reference for all options and use cases
- **PyTorch example source:** `examples/pytorch/codegen/python/custom_module.py`
- **JAX example source:** `examples/jax/codegen/python/custom_module.py`
